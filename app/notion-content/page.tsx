...
export default async function NotionContentPage() {
  // Use the main DevOps URL as fallback if no specific URL is configured
  const notionUrl = process.env.NOTION_PAGE_URL || "https://atulmaurya.notion.site/Let-s-learn-DevOps-29d76b1df1a88072a9bfcc78d1c7d881?source=copy_link";
  
  if (!notionUrl) {
    return (
      <main style={{ padding: 24 }}>
        <h1>No content available</h1>
        <p>Please configure a Notion URL for this content.</p>
      </main>
    );
  }
